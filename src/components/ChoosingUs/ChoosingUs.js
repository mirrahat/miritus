    ...
    return(
        <div style={{backgroundColor: '#fff1e5'}}>
            <div className="container">
                <p className={styles.heading}>Top three the reason why you should choosing us.</p>
                <p className={styles.sub_text}>In quo quaerimus, non numquam eius modi tempora incidunt</p>
